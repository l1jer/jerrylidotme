      ...
      <div className="relative container mx-auto px-6 py-10">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-300  text-center">
            © {new Date().getFullYear()} Jerry Li,  <a className=" text-gray-300 hover:text-indigo-300" href="https://digolasforge.com" target="_blank" rel="noopener noreferrer">@Digolas Forge</a>. All rights reserved.
          </p>
